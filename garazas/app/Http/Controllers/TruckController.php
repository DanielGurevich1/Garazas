...
class TruckController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $truck->save();
        return redirect()->route('truck.index')->with('success_message', 'Record done');
    }
    ...
    public function update(Request $request, Truck $truck)
    {
        ...
        $truck->mechanic_id = $request->mechanic_id;
        $truck->save();
        return redirect()->route('truck.index')->with('success_message', 'Updated!');;
    }
    ...
    public function destroy(Truck $truck)
    {
        ...
        $truck->delete();
        return redirect()->route('truck.index')->with('success_message', 'Deleted!');
    }
}
